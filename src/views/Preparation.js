           ...
           <Col lg="8">
             <Card className="about-card">
               <CardBody>
                 ...
                 <p className="about-text">
                 As you journey through the game, you may need to interact with the code in Remix. Simply copy and paste your code into Remix and add the contract address created for your instance (click 'At Address', choose MetaMask as the provider, and you're all set).
                 </p>
